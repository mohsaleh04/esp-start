...
Espressif رسماً GPIOهای `0,2,5,12,15` رو strapping معرفی می‌کنه؛ `34–39` فقط ورودی‌اند و `6–11` برای Flash استفاده
می‌شن. ([Espressif Systems][3])
...
`set_high()` رو کنار بذاریم و **مستقیماً رجیستر MMIO مربوط به GPIO25 رو با Rust بنویسیم**. اونجا دقیقاً می‌بینی HAL پشت
